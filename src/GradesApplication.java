...
public class GradesApplication {
    public static void main(String[] args) {
        ...
        students.put("CodingDude222", new Student("Josh",new ArrayList<>()));
        ...
        students.get("CodingDude222").addGrade(80);
        students.get("CodingDude222").addGrade(90);
        students.get("CodingDude222").addGrade(100);
        ...
        for (int x = 0; x < 1;){
            ...
            if (userResponse.equalsIgnoreCase("evanwilliamsC137")) {
                ...
                System.out.println("Would you like to see another student's information?");
                ...
                } else if (userResponse.equalsIgnoreCase("CodingDude222")) {
                System.out.println("Name: " + students.get("CodingDude222").getName());
                System.out.println("Grade average: " + students.get("CodingDude222").getGradeAverage());
                System.out.println("Would you like to see another student's information?");
                String yesNo = sc.nextLine();
                if(yesNo.equalsIgnoreCase("Y") || yesNo.equalsIgnoreCase("Yes")){
                    x = 0;
