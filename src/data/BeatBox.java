...
public class BeatBox {
    ...
    public void buildGUI(){
        ...
        buttonBox.add(save);
        JButton loadSaved = new JButton("Load");
        loadSaved.addActionListener(new MyReadInListener());
        buttonBox.add(loadSaved);
    ...
    } // close UpTempListener inner class
    public class MyDownTempoListner implements ActionListener {
        public void actionPerformed(ActionEvent a){
            float tempoFactor = sequencer.getTempoFactor();
            sequencer.setTempoFactor((float) (tempoFactor * .97));
        }
    } // close DownTempoListener inner class
